...
perl ../any2agi.pl --debug-input --debug-proc --debug-agi kq6flute.it out_kq6flute.ags >out_kq6flute.txt
...
perl ../any2agi.pl --debug-input --debug-proc --debug-agi --auto-drum-offs 2 kq6flute.it out_kq6flute.ags >out_kq6flute.txt
...
perl ../any2agi.pl --debug-input --debug-proc --debug-agi --instr 5 note 13 --instr 6 note 14 --instr 4 note 15 --instr 11 note 14 --arpspeed 2 --auto-drum-offs 1 --channels 2,3,4,1 cremona.mod out_cremona.ags >out_cremona.txt
...
perl ../any2agi.pl --debug-input --debug-proc --debug-agi --length 500 --instr 5 note 13 --instr 6 note 14 --instr 4 note 15 --instr 11 note 14 --instr 1 arp 047 --instr 2 arp 037 --instr 12 arp 037 --instr 13 arp 047 --arpspeed 2 --auto-drum-offs 1 --channels 2,3,4,1 cremona.mod out_cremona.ags >out_cremona.txt
...
perl ../any2agi.pl --debug-input --debug-proc --debug-agi --nomidiremap wlaskot.mid out_wlaskot.ags >out_wlaskot.txt
...
perl ../any2agi.pl --debug-input --debug-proc --debug-agi wlaskot.mid out_wlaskot.ags >out_wlaskot.txt
...
perl ../any2agi.pl --debug-input --debug-proc --debug-agi aladdin-onejump.vgm out_aladdin-onejump.ags >out_aladdin-onejump.txt
...
echo [47;30m AGS: DEFAULT [0m
perl ../any2agi.pl --debug-input --debug-proc --debug-agi expect-aladdin-onejump.ags out_aladdin-onejump.ags >out_aladdin-onejump-agsags.txt
fc out_aladdin-onejump-agsags.txt expect-aladdin-onejump-agsags.txt >nul
call :RESULTS Debug %ERRORLEVEL% nostop
fc /b out_aladdin-onejump.ags expect-aladdin-onejump.ags >nul
call :RESULTS Output %ERRORLEVEL%
if "%1"=="savedebug" copy /y out_aladdin-onejump-agsags.txt expect-aladdin-onejump-agsags.txt
del out_*.ags out_*.txt
